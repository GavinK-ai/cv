...
# /
@app.route('/tire_resnet', methods=['GET', 'POST'])
def tire_resnet():
    ...
    <title>Computer Vision</title>
    <div>
    <h1 style="text-align:center">Upload Tire Photo</h1>
    </div>
    <div style="color: red">
      {error}
    </div>
    ...
    <div>
      <h3 style="font-size:150%; text-align:center">Prediction</h3>

      <p style="color: blue; font-size:150%; text-align:center">{predictedLabel}<p>
      
      <center><img src="static/uploads/{originalUri}" width="400" height="400"/></center>
    </div>
    '''
